  ...
  render() {
    return (
      <div className="Other section-flex">
          ...
          <a style={{ 'color': '#0070ff', }} rel="noopener" href='https://CalculatorHTML.quinnthecoder.repl.co'>Calculator</a>
          <iframe title="Calculator" style={{ 'height': '30rem', 'width': '25rem', }} src='https://CalculatorHTML.quinnthecoder.repl.co' class='rounded-lg m-auto'></iframe>
      </div>
    )
  }
}
